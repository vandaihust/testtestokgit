let imageProcessingRadios = [
  {
    id: "rgba2gray",
    desc: "Chuyển rgba sang ảnh xám",
    checked: true
  },
  {
    id: "extractChannel",
    desc: "Tách ảnh sang R, G, B ",
  ...
  {
    id: "medianFilter",
    desc: "Hình mịn qua bộ lọc trung vị"
  },
  {
    id: "boxFilter",
    desc: "Hình mịn qua bộ lọc hộp"
  },
  {
    id: "sobel",
    desc: "Phát hiện biên thông qua bộ lọc sobel"
  },
  {
    id: "canny",
    desc: "Phát hiện biên với canny với ngưỡng thấp: ",
    lowThreshold: [50, 100],
    handler: thresholdChangeEventHandler
  },
  {
    id: "houghLinesP",
    desc: "houghLinesP - Phát hiện ra dòng có ngưỡng thấp ",
    lowThreshold: [50, 100],
    handler: thresholdChangeEventHandler
  },
  {
    id: "houghCircle",
    desc: "houghCircle - Phát hiện vòng kết nối",
    lowThreshold: [50, 100],
    handler: thresholdChangeEventHandler
  }
];
